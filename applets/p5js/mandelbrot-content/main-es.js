...
function draw() {
    ...
    if (starting == false) {
        ...
        textAlign(LEFT);
        textSize(32);
        text("Usa los controles del lado izquierdo,", width / 2 - 180, height / 2 - 120);
        text("o las teclas correspondientes.", width / 2 - 180, height / 2 - 70);
        textAlign(CENTER);
...
function controlsUI() {
    ...
    buttonRESET.position(buttonUP.x - 18, buttonUP.y + 200);
    buttonRESET.addClass('button');
    buttonRESET.mousePressed(userRESET);

    buttonORBIT = createButton('Orbit');
    buttonORBIT.position(buttonUP.x - 16, buttonUP.y + 250);
    buttonORBIT.addClass('button');
    buttonORBIT.mousePressed(userORBIT);

    buttonINFO = createButton('Info');
    buttonINFO.position(buttonUP.x - 13, buttonUP.y + 300);
