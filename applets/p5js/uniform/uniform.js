/* Uniform simulation designed with p5.js (https://p5js.org/)
 Under Creative Commons License
 https://creativecommons.org/licenses/by-sa/3.0/
 
 Writen by Juan Carlos Ponce Campuzano, 10-Jan-2020
 */
...
let buttonField, buttonTrace, sliderA, sliderU;
...
function draw() {
    ...
    textSize(16);
    fill(250);
    text('alpha = '+nfc(sliderA.value(),2),-210, 200);//for slider A
    text('U = '+nfc(sliderU.value(),1),-20, 200);//for slider U
...
let P = (t, x, y) => sliderU.value() * cos(sliderA.value()) ;//Change this function
let Q = (t, x, y) => sliderU.value() * sin(sliderA.value()) ;//Change this function
...
function controls() {
    ...
    sliderA = createSlider(0, 2*PI, 1, 0.01);
    sliderA.position(60, 460);
    sliderA.style('width', '150px');

    sliderU = createSlider(-3, 3, 1, 0.1);
    sliderU.position(250, 460);
